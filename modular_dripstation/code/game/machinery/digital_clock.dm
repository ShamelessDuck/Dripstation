/obj/machinery/digital_clock //tg port
	name = "digital clock"
	...
	icon = 'modular_dripstation/icons/obj/digital_clock.dmi'
	verb_say = "beeps"
	verb_ask = "bloops"
	verb_exclaim = "blares"
	density = FALSE
...
/obj/machinery/digital_clock/proc/update_time()
	...
	var/mutable_appearance/minute_one_overlay = mutable_appearance('modular_dripstation/icons/obj/digital_clock.dmi', "+[station_minute_one]")
	minute_one_overlay.pixel_w = 0
	return_overlays += minute_one_overlay

	var/mutable_appearance/minute_tenth_overlay = mutable_appearance('modular_dripstation/icons/obj/digital_clock.dmi', "+[station_minute_tenth]")
	minute_tenth_overlay.pixel_w = -4
	return_overlays += minute_tenth_overlay

	var/mutable_appearance/separator = mutable_appearance('modular_dripstation/icons/obj/digital_clock.dmi', "+separator")
	return_overlays += separator

	var/mutable_appearance/hour_one_overlay = mutable_appearance('modular_dripstation/icons/obj/digital_clock.dmi', "+[station_hours_one]")
	hour_one_overlay.pixel_w = -10
	return_overlays += hour_one_overlay

	var/mutable_appearance/hour_tenth_overlay = mutable_appearance('modular_dripstation/icons/obj/digital_clock.dmi', "+[station_hours_tenth]")
